...
#### 2. What is the distribution of availability of the listings in a given 365-
day period?
...
listings %>% ggplot(mapping = aes(x = availability_365)) +
    ...
    labs(x = "", y = "Number of Listings", title = "Histogram of Availability
         of Airbnb Listings in a Given 365-day Period") +
...
#### 3. Why are there 6947 listings for `availability_365` = 0? What does it
...
#### 4. Are there more listings in popular tourist destinations?
